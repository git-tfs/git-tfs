    ...
    public class TfsHelper : ITfsHelper
    {
        ...
        public IList<RootBranch> GetRootChangesetForBranch(string tfsPathBranchToCreate, int lastChangesetIdToCheck = -1, string tfsPathParentBranch = null)
        {
            ...
            if (firstBranchChangeset != null)
            {
                do
                {
                    var rootBranch = new RootBranch(firstBranchChangeset.BranchChangesetDatas.RootChangesetId, firstBranchChangeset.Id,
                    ...
                    firstBranchChangeset = branchChangesets.FirstOrDefault(
                        c => c.BranchChangesetDatas.BranchPath == firstBranchChangeset.BranchChangesetDatas.ParentBranch);

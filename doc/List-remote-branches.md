...
Then you can use the `[[clone]]` command with the good remote branch of your choice!
However, it is recommanded to clone the root branch and then use the `[[branch]]` command to manage branches. 

...
namespace Sep.Git.Tfs.Commands
{
    ...
    {
        public QuickFetch(Globals globals, RemoteOptions remoteOptions, AuthorsFile authors, TfsTreeEntryVerifier verifier) 
            : base(globals, remoteOptions, authors, null, verifier)
        {
        }
